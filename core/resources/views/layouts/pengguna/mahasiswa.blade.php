        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="panel-title">Daftar mahasiswa anda</span>
                </div>
                    ...
                    <div class="table-responsive">
						...
						<thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if($mahasiswa->photo_url == null){
                                    ?>
                                    belum diunggah
                                    <?php
                                    }else{
                                    ?>
                                    <a href="<?php echo $mahasiswa->photo_url;?>" target="_blank" class="btn btn-info">Lihat</a>
                                    <?php
                                    }
                                    ?>
                                </td>
                                <td>
                                    <?php
                                    if($mahasiswa->status_konfirmasi == 0){
                                    ?>
                                    <span class="label label-default">Tidak diterima</span>

                                    <?php
                                    }else if ($mahasiswa->status_konfirmasi == 1) {
                                    ?>
                                ...
                                <td>
                                    <?php
                                    if($mahasiswa->status_konfirmasi == 1){
                                        echo "-";
                                    }else{
                                    ?>
                                    <form method="post" action="mahasiswa/proses_konfirmasi">
