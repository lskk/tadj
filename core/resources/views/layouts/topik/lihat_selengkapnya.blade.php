...
@section('content')
    <div class="container">
        <form method="post" action="../topik/cari">
            ...
            <div class="row">
                <div class="container">
                    <span class="label label-danger">Silahkan pilih judul yang tersedia, apabila anda ingin mengambil judul yang dipilih, klik ambil judul (bila tersedia).</span>
                </div>
            </div>
            <?php
            }
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <form method="post" action="../kelompok/ambil_topik">
                                                            ...
                                                            <button type="submit" class="btn btn-danger" onclick="return confirm('Kelompok anda yakin ingin mengambil judul ini?(Setelah diambil tidak bisa reset/ganti judul)')">Ambil Judul
                                                            </button>
                                                            <?php
                                                            }else {
                                                                echo "-";
